        ...
        if (keyword.length == 0) {
            ...
            xhr = $.ajax({
                ...
                beforeSend: function() {
                    ...
                    $("#auto_suggestions_list").html('<p style="margin: 7px 5px;">Loading...</p>');
                },
                success: function (data, textStatus) {
                    ...
                    if (data) {
                        ...
                        $("#auto_suggestions_list").html('<p style="margin: 7px 5px;">No record found</p>');
                ...
                error: function (o) {
                    console.log("search abort/timeout");
                    lookup(keyword);
